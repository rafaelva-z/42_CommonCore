...
\
The smallest step here is to draw a pixel on the screen, that i already learned how to do on the [Minilibx](https://harm-smits.github.io/42docs/libs/minilibx) documentation, and after that i had to find how to draw a line. After some research I found the [Bresenham's line algorithm](https://en.wikipedia.org/wiki/Bresenham%27s_line_algorithm) and used it to draw lines from a point_a to a point_b. \
...
//////////////
For the bonus of this project the program must be able to rotate, translate and scale. \
...
\
I also added scale and translation (offset), to the model on the 3D to 2D formula by multiplying the reult of X and Y by de scale, and the adding the offset value \
